...
class Social_Login_Updates extends Security_Controller {
    ...
    function index() {
        ...
        echo $this->template->view("Social_Login\Views\updates\index", $view_data);
    }
    ...
    private function _get_support_info() {
        ...
        $item_purchase_code = get_social_login_setting("social_login_item_purchase_code");
